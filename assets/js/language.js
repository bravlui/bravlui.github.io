	...
	var translations = {
		en: {
			...
			items: [
				...
				['.portfolio-list article:nth-child(1) .portfolio-main > p', "Experimental pipeline evaluating Query Fairness Estimation methods (Naive@k, CC, PACC, KDEy) under low availability of demographic labels, extending Jaenich et al. (2026) to correction pools of 100–10,000 labeled documents over 162,200 documents and 25 queries from trec-fair/2022. Proposes dRAE, a rank-discounted extension of RAE, and shows that recalibrating the sensitive-attribute classifier via temperature scaling cuts KDEy's error from 0.792 to 0.094."],
				['.portfolio-list article:nth-child(1) .project-applications', 'Applications in search and recommendation', 'aria-label'],
				['.portfolio-list article:nth-child(1) .applications-label', 'Applications in'],
				['.portfolio-list article:nth-child(1) .project-applications h4', 'Search and recommendation'],
				['.portfolio-list article:nth-child(1) .project-applications li:nth-child(1)', 'Auditing exposure bias.'],
				['.portfolio-list article:nth-child(1) .project-applications li:nth-child(2)', 'Assessing fairness with limited demographic data.'],
				['.portfolio-list article:nth-child(1) .project-applications li:nth-child(3)', 'Recalibrating models for sensitive decisions.'],
				...
				['.portfolio-list article:nth-child(2) .portfolio-main > p', 'Research developed in partnership between UNESP and PETROBRAS, applying Computer Vision and Graph Neural Networks to the automatic classification of microfossils in scientific imaging.'],
				['.portfolio-list article:nth-child(2) .project-applications', 'Applications in scientific image analysis', 'aria-label'],
				['.portfolio-list article:nth-child(2) .applications-label', 'Applications in'],
				['.portfolio-list article:nth-child(2) .project-applications h4', 'Scientific image analysis'],
				['.portfolio-list article:nth-child(2) .project-applications li:nth-child(1)', 'Automated screening of large image collections.'],
				['.portfolio-list article:nth-child(2) .project-applications li:nth-child(2)', 'Prioritization of uncertain cases for experts.'],
				['.portfolio-list article:nth-child(2) .project-applications li:nth-child(3)', 'Reduced time and cost of manual analysis.'],
				...
				['.portfolio-list article:nth-child(3) .portfolio-main > p', 'Systematic study of six network sampling methods across three classic synthetic graph models (Erdős–Rényi, Barabási–Albert, Watts–Strogatz) and two network sizes, evaluating how well each method preserves the original topology using KL, JS, Wasserstein, and KS distance metrics. Coursework for Complex Networks and Dynamic Processes (ICMC-USP).'],
				['.portfolio-list article:nth-child(3) .project-applications', 'Applications in large-scale networks', 'aria-label'],
				['.portfolio-list article:nth-child(3) .applications-label', 'Applications in'],
				['.portfolio-list article:nth-child(3) .project-applications h4', 'Large-scale networks'],
				['.portfolio-list article:nth-child(3) .project-applications li:nth-child(1)', 'Network reduction with structural preservation.'],
				['.portfolio-list article:nth-child(3) .project-applications li:nth-child(2)', 'Lower-cost simulations and analyses.'],
				['.portfolio-list article:nth-child(3) .project-applications li:nth-child(3)', 'Study of social, transactional, and biological networks.'],
				...
				['.portfolio-list article:nth-child(4) .portfolio-main > p', "Full-stack project combining a FastAPI backend, a Next.js frontend, and a machine learning training pipeline into an intelligent chatbot for predictive maintenance analysis. Coursework for the Deep Learning discipline of UNESP's Graduate Program in Computer Science."],
				['.portfolio-list article:nth-child(4) .project-applications', 'Applications in industrial operations', 'aria-label'],
				['.portfolio-list article:nth-child(4) .applications-label', 'Applications in'],
				['.portfolio-list article:nth-child(4) .project-applications h4', 'Industrial operations'],
				['.portfolio-list article:nth-child(4) .project-applications li:nth-child(1)', 'Anticipating equipment failures.'],
				['.portfolio-list article:nth-child(4) .project-applications li:nth-child(2)', 'Querying indicators in natural language.'],
				['.portfolio-list article:nth-child(4) .project-applications li:nth-child(3)', 'Prioritizing inspections and maintenance.'],
				...
				['.portfolio-list article:nth-child(5) .portfolio-main > p', 'Coursework for SME0878 — Statistical Data Mining (USP), applying statistical data mining techniques to a real dataset.'],
				['.portfolio-list article:nth-child(5) .project-applications', 'Applications in data-driven decisions', 'aria-label'],
				['.portfolio-list article:nth-child(5) .applications-label', 'Applications in'],
				['.portfolio-list article:nth-child(5) .project-applications h4', 'Data-driven decisions'],
				['.portfolio-list article:nth-child(5) .project-applications li:nth-child(1)', 'Identifying patterns and segments.'],
				['.portfolio-list article:nth-child(5) .project-applications li:nth-child(2)', 'Analyzing factors associated with outcomes.'],
				['.portfolio-list article:nth-child(5) .project-applications li:nth-child(3)', 'Building predictive models.'],
		...
		pt: {
			...
			items: [
				...
				['.portfolio-list article:nth-child(1) .portfolio-main > p', 'Pipeline experimental que avalia métodos de estimação de equidade em consultas (Naive@k, CC, PACC e KDEy) sob baixa disponibilidade de rótulos demográficos. O estudo estende Jaenich et al. (2026) para conjuntos de correção de 100 a 10.000 documentos rotulados, em uma coleção de 162.200 documentos e 25 consultas do trec-fair/2022. Propõe o dRAE, uma extensão do RAE com desconto por posição, e mostra que recalibrar o classificador de atributo sensível por temperature scaling reduz o erro do KDEy de 0,792 para 0,094.'],
				['.portfolio-list article:nth-child(1) .project-applications', 'Aplicações em busca e recomendação', 'aria-label'],
				['.portfolio-list article:nth-child(1) .applications-label', 'Aplicações em'],
				['.portfolio-list article:nth-child(1) .project-applications h4', 'Busca e recomendação'],
				['.portfolio-list article:nth-child(1) .project-applications li:nth-child(1)', 'Auditoria de vieses de exposição.'],
				['.portfolio-list article:nth-child(1) .project-applications li:nth-child(2)', 'Avaliação de equidade com poucos dados demográficos.'],
				['.portfolio-list article:nth-child(1) .project-applications li:nth-child(3)', 'Recalibração de modelos para decisões sensíveis.'],
				...
				['.portfolio-list article:nth-child(2) .portfolio-main > p', 'Pesquisa desenvolvida em parceria entre UNESP e PETROBRAS, aplicando Visão Computacional e Redes Neurais de Grafos à classificação automática de microfósseis em imagens científicas.'],
				['.portfolio-list article:nth-child(2) .project-applications', 'Aplicações em análise de imagens científicas', 'aria-label'],
				['.portfolio-list article:nth-child(2) .applications-label', 'Aplicações em'],
				['.portfolio-list article:nth-child(2) .project-applications h4', 'Análise de imagens científicas'],
				['.portfolio-list article:nth-child(2) .project-applications li:nth-child(1)', 'Triagem automática de grandes volumes de imagens.'],
				['.portfolio-list article:nth-child(2) .project-applications li:nth-child(2)', 'Priorização de casos incertos para especialistas.'],
				['.portfolio-list article:nth-child(2) .project-applications li:nth-child(3)', 'Redução do tempo e do custo de análises manuais.'],
				...
				['.portfolio-list article:nth-child(3) .portfolio-main > p', 'Estudo sistemático de seis métodos de amostragem em três modelos clássicos de grafos sintéticos (Erdős–Rényi, Barabási–Albert e Watts–Strogatz) e dois tamanhos de rede. Avalia a preservação da topologia original por meio das métricas de distância KL, JS, Wasserstein e KS. Trabalho da disciplina Redes Complexas e Processos Dinâmicos (ICMC-USP).'],
				['.portfolio-list article:nth-child(3) .project-applications', 'Aplicações em redes de grande escala', 'aria-label'],
				['.portfolio-list article:nth-child(3) .applications-label', 'Aplicações em'],
				['.portfolio-list article:nth-child(3) .project-applications h4', 'Redes de grande escala'],
				['.portfolio-list article:nth-child(3) .project-applications li:nth-child(1)', 'Redução de redes preservando características estruturais.'],
				['.portfolio-list article:nth-child(3) .project-applications li:nth-child(2)', 'Simulações e análises com menor custo computacional.'],
				['.portfolio-list article:nth-child(3) .project-applications li:nth-child(3)', 'Estudo de redes sociais, transacionais e biológicas.'],
				...
				['.portfolio-list article:nth-child(4) .portfolio-main > p', 'Projeto full-stack que integra backend em FastAPI, frontend em Next.js e um pipeline de treinamento de aprendizado de máquina em um chatbot inteligente para análise de manutenção preditiva. Trabalho da disciplina de Aprendizado Profundo do Programa de Pós-Graduação em Ciência da Computação da UNESP.'],
				['.portfolio-list article:nth-child(4) .project-applications', 'Aplicações em operações industriais', 'aria-label'],
				['.portfolio-list article:nth-child(4) .applications-label', 'Aplicações em'],
				['.portfolio-list article:nth-child(4) .project-applications h4', 'Operações industriais'],
				['.portfolio-list article:nth-child(4) .project-applications li:nth-child(1)', 'Antecipação de falhas em equipamentos.'],
				['.portfolio-list article:nth-child(4) .project-applications li:nth-child(2)', 'Consulta de indicadores em linguagem natural.'],
				['.portfolio-list article:nth-child(4) .project-applications li:nth-child(3)', 'Priorização de inspeções e manutenções.'],
				...
				['.portfolio-list article:nth-child(5) .portfolio-main > p', 'Trabalho da disciplina SME0878 — Mineração Estatística de Dados (USP), aplicando técnicas estatísticas de mineração a um conjunto de dados real.'],
				['.portfolio-list article:nth-child(5) .project-applications', 'Aplicações em decisões orientadas por dados', 'aria-label'],
				['.portfolio-list article:nth-child(5) .applications-label', 'Aplicações em'],
				['.portfolio-list article:nth-child(5) .project-applications h4', 'Decisões orientadas por dados'],
				['.portfolio-list article:nth-child(5) .project-applications li:nth-child(1)', 'Identificação de padrões e segmentos.'],
				['.portfolio-list article:nth-child(5) .project-applications li:nth-child(2)', 'Análise dos fatores associados a resultados.'],
				['.portfolio-list article:nth-child(5) .project-applications li:nth-child(3)', 'Construção de modelos preditivos.'],
