(function () {
	...
	var translations = {
		en: {
			...
			items: [
				['#intro .eyebrow', 'Statistics · Artificial Intelligence · Information Retrieval'],
				['#intro > p:not(.eyebrow)', 'Exploring how intelligent systems learn similarity, context,<br class="desktop-only"> uncertainty, and relationships.'],
				...
				['#about h2', 'Where disciplines<br>meet and challenge each other'],
				...
				['#about .major p:nth-of-type(2)', 'Rather than viewing Artificial Intelligence as a single discipline, I see it as a meeting point between statistics, optimization, networks, information retrieval, and human reasoning.'],
				['#about img', 'Portrait of Luiz Bravo', 'alt'],
				['#about .question-grid', 'Research questions', 'aria-label'],
				['#about .question-grid p:nth-child(1)', 'Can uncertainty improve representation learning?'],
				['#about .question-grid p:nth-child(2)', 'How can context be incorporated into similarity learning?'],
				['#about .question-grid p:nth-child(3)', 'Can probabilistic reasoning improve ranking and retrieval?'],
				['#about .question-grid p:nth-child(4)', 'How can graphs enrich visual and semantic representations?'],
				['#research .section-label', 'Current research'],
				['#research header h2', 'Questions I am<br>trying to understand'],
				...
				['#writing .section-label', 'Writing'],
				['#writing h2', 'Ideas beyond<br>the research paper'],
				['#writing div > p', 'I write about technology, artificial intelligence, learning, interdisciplinarity, and the relationship between people and knowledge.'],
				['#writing .button', 'Read on Medium'],
				['#writing li:nth-child(1)', 'Artificial Intelligence and Authorship'],
				['#writing li:nth-child(2)', 'Adaptation versus Change'],
				['#writing li:nth-child(3)', 'Interdisciplinary Thinking'],
				['#writing li:nth-child(4)', 'Specialization and Innovation'],
				['#writing li:nth-child(5)', 'Technology and Society'],
		...
		pt: {
			...
			items: [
				['#intro .eyebrow', 'Estatística · Inteligência Artificial · Recuperação de Informação'],
				['#intro > p:not(.eyebrow)', 'Explorando como sistemas inteligentes aprendem similaridade, contexto,<br class="desktop-only"> incerteza e relações.'],
				...
				['#about h2', 'Onde disciplinas<br>se encontram e se desafiam'],
				...
				['#about .major p:nth-of-type(2)', 'Em vez de enxergar a Inteligência Artificial como uma única disciplina, vejo-a como um ponto de encontro entre estatística, otimização, redes, recuperação de informação e raciocínio humano.'],
				['#about img', 'Retrato de Luiz Bravo', 'alt'],
				['#about .question-grid', 'Questões de pesquisa', 'aria-label'],
				['#about .question-grid p:nth-child(1)', 'A incerteza pode aprimorar o aprendizado de representações?'],
				['#about .question-grid p:nth-child(2)', 'Como incorporar contexto ao aprendizado de similaridade?'],
				['#about .question-grid p:nth-child(3)', 'O raciocínio probabilístico pode melhorar o ranqueamento e a recuperação?'],
				['#about .question-grid p:nth-child(4)', 'Como grafos podem enriquecer representações visuais e semânticas?'],
				['#research .section-label', 'Pesquisa atual'],
				['#research header h2', 'Questões que estou<br>buscando compreender'],
				...
				['#writing .section-label', 'Textos'],
				['#writing h2', 'Ideias além<br>do artigo científico'],
				['#writing div > p', 'Escrevo sobre tecnologia, inteligência artificial, aprendizagem, interdisciplinaridade e a relação entre pessoas e conhecimento.'],
				['#writing .button', 'Ler no Medium'],
				['#writing li:nth-child(1)', 'Inteligência Artificial e Autoria'],
				['#writing li:nth-child(2)', 'Adaptação versus Mudança'],
				['#writing li:nth-child(3)', 'Pensamento Interdisciplinar'],
				['#writing li:nth-child(4)', 'Especialização e Inovação'],
				['#writing li:nth-child(5)', 'Tecnologia e Sociedade'],
